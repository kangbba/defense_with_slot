...
public class CellMaker : MonoBehaviour
{
    ...
    public Cell CreateCell(Vector2Int gridPos, int width, int height, Vector3 center, Transform parent)
    {
        Vector3 worldPos = ComputeWorldPos(gridPos, width, height, center);
        var cellObj = Object.Instantiate(_cellPrefab, worldPos, Quaternion.identity, parent);
